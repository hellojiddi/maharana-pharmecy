...
const documents = [
  {
    ...
    link: '/pdf/PCI-approval-Letter-of-Maharana-Pratap.pdf',
  },
  {
    num: '02',
    icon: FileText,
  ...
  },
  {
    ...
    link: '/pdf/Affiliation-Letter-BUHS-Patna.pdf',
  },
  {
    num: '04',
    icon: FileText,
    ...
    link: '/pdf/Bihar-State-Govt-NOC-for-D.Pharm-B.Pharm.pdf',
  },
  {
    num: '05',
    icon: FileCheck,
    ...
    link: '/pdf/Consent-of-affiliation-B.Pharm-D.pharm.pdf',
  },
];
